...
import { Row,Button,Col,Autocomplete,Input,Navbar, NavItem,Parallax } from "react-materialize"
...
componentWillUpdate
 ...
 <Row>
         ...
         {/* <Parallax imageSrc="http://oyster.ignimgs.com/wordpress/stg.ign.com/2018/02/newpok.jpg"/> */}
              ...
              <div className="searcharea">
                    ...
                    <Row s={12}>
                      ...
                      <Col s={3}>
                        ...
                        />
                        <Button floating large className="searchButton" waves='light' icon='search' onClick={this.searchPokemon.bind(this)}/>
                      </Col>
            ...
            <Parallax imageSrc="http://images.nintendolife.com/e64ccb3204883/pokemon-go.original.jpg"/>
