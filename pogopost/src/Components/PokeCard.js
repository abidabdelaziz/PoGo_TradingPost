...
import { CollectionItem, Card, CardTitle,Row,Col,Button,Modal,Autocomplete,Input} from "react-materialize"
...
class PokeCard extends Component {
    ...
    makeOffer = () =>{
       ...
       const trade={
        tradeOne:{
            "pokemon":this.props.pkmns.pokemon,
            "cp": this.props.pkmns.cp,
            "gender" : this.props.pkmns.gender,
            "location": this.props.pkmns.location,
            "fastmove": this.props.pkmns.fastmove,
    ...
    render() {
      ...
      return (
            <CollectionItem s={12}>
                ...
                <Card horizontal header={<CardTitle image={this.state.pokePic[this.props.pkmns.pokemon]}>
                     
                  <Modal
                      actions={[
                          <Button waves="light" modal="close" flat> Offer </Button>
                      ]}
                      modalOptions={{
