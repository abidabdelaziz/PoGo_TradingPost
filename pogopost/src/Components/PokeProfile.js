...
class PokeProfile extends Component {
  ...
  axios.get(`pkmn/userTrades/${this.props.email}`).then(res =>{

      this.setState({activeTrades:res.data})
  ...
  componentWillMount(){
    ...
    render() {
          ...
          console.log("hi", typeof this.state.activeTrades)
      return (
...
export default observer(PokeProfile);