...
class PokeTrade extends Component {
    ...
    constructor () {
       ...
       componentWillReceiveProps(props){
           this.setState({tradeOne:props.tradeOne})
           this.setState({tradeTwo:props.tradeTwo})
    ...
    postChat=event=>{
        ...
        const message={
            trade:[this.props.tradeOne.pokemon,this.props.tradeTwo.pokemon].join(' '),
            fromName:this.props.tradeOne.trainername,
            fromEmail:this.props.tradeOne.email,
            toName:this.props.tradeTwo.trainername,
            toEmail:this.props.tradeTwo.email,
    ...
    render() {
      ...
      return (
       ...
       <Row className="myTrade"> 
          <Row >
              <Col className="tradePkmn">
                  <img className="tradeIm" src={this.state.pokePic[this.props.tradeOne.pokemon]} />
                  

              </Col>

              <Col className="tradePkmn">
                  <img className="tradeIm" src={this.state.pokePic[this.props.tradeTwo.pokemon]} /></Col>
              ...
              <Row className="overLay">
                  ...
                  <Modal
                      ...
                      trigger={<Button>Trade Info</Button>}>
                      <CardPanel className="tradeInfo" >
                          <span>
                          <p> {this.props.tradeTwo.pokemon}</p>
                          <p> CP: {this.props.tradeTwo.cp} </p>
                          <p> Quick Move: {this.props.tradeTwo.fastmove}</p>
                          <p> Charge Move: {this.props.tradeTwo.chargemove}</p>
                          <p> Gender: {this.props.tradeTwo.gender}</p>
                          <p> Trainer : {this.props.tradeTwo.trainername} </p>
                          <p> Trainer Notes: {this.props.tradeTwo.notes}  </p>
                          </span>
                      </CardPanel>
                      <CardPanel className="tradeInfo">
                      <span>
                          <p> {this.props.tradeOne.pokemon}</p>
                          <p> CP: {this.props.tradeOne.cp} </p>
                          <p> Quick Move: {this.props.tradeOne.fastmove}</p>
                          <p> Charge Move: {this.props.tradeOne.chargemove}</p>
                          <p> Gender: {this.props.tradeOne.gender}</p>
                          <p> Trainer : {this.props.tradeOne.trainername} </p>
                          <p> Trainer Notes: {this.props.tradeOne.notes}  </p>
                          </span>
                      </CardPanel>
                  </Modal>
                 ...
                 floating large  className='messageButton' waves='light' icon='message' />
                 <textarea value ={this.state.chat} onChange={this.handleChat}className="messageText"> </textarea>
                 </Row>
...
export default observer(PokeTrade);